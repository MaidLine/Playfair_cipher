namespace Playfair_cipher
{
    public partial class Form_Auth : Form
    {
        ...
        {
            if (textBox_Login.Text == "" || textBox_Password.Text == "" || textBox_Password_Repeated.Text == "") MessageBox.Show("Убедитесь в том, что бы заполнили все поля", "Ошибка!", MessageBoxButtons.OK, MessageBoxIcon.Warning);
